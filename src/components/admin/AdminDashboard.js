...
const AdminDashboard = () => {
    ...
    return (
        <div className="admin-dashboard">
            ...
            <button className='btn btn-primary' style={{marginLeft:"900px", border:"none", borderWidth:"30px"}}><Link to="/contact/list" style={{color:"white"}}>Contact</Link></button>
            <button className='btn btn-primary' style={{marginLeft:"10px", border:"none", borderWidth:"30px"}}><Link to="/adminlogin" style={{color:"white"}}>Logout</Link></button>
                <h1 className="p-4">
